...
## 2026-08-19 — 人物PROFILEの直接LINKSはCONFIRMEDな公開URLだけを掲載する
...
- 人物ごとのリンク数は異なってよい
- 公平性のために未確認URLを補完しない
- 本人の非掲載希望が確認されている場合は、親ポータルでも尊重する

**Reason**

親ポータルは5人を同等weightで扱うが、公平性は「全員に同じUIルール・同じ確認基準を適用すること」で担保するものであり、リンク件数を揃えることでは担保しない。件数合わせのための推測URLは、誤情報と本人意思の侵害の両方を生む。
...
## 2026-08-19 — SUPPORT導線はLINKSと分け、期限依存の状態表現を静的UIへ書かない
...
## 2026-08-19 — LINKS / SUPPORT の個別判断

**Decision**

- **MAKO**: X / SHOWROOMは本人アカウントと確認できているが、子サイト側の運用方針にあわせ、親ポータルでも本人希望を尊重して非掲載とする
